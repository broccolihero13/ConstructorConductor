...
//Let's say three people signed up for our service, create 3 instances of User and add each to the users Array
  ...
  //code here
quizUsers.push(new QuizUser('Mickey', 'mickeymouse@disney.com', 'allEars', 88));
quizUsers.push(new QuizUser('Minnie', 'minniemouse@disney.com', 'allEarsAndABow', 92));
quizUsers.push(new QuizUser('Pluto', 'pluto@disney.com', 'woof', 73));
